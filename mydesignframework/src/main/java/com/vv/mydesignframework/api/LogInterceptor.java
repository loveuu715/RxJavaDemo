...
public class LogInterceptor implements Interceptor {
    public static final String TAG = "VVTAG";
    private String tag;
    //默认不打印响应体
...
//            e.printStackTrace();
    ...
    private void logForRequest(Request request) {
        try {
            ...
            LocalExceptionHelper localExceptionHelper = new LocalExceptionHelper(BaseApplication.getApplication());
            localExceptionHelper.handleException(e);
//            e.printStackTrace();
        }
    }
